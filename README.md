...
4. **`image_grid`** : This corresponds to the number of images(with different seeds) generated by the model per prompt, where a value of **1** means 1 image, **2** means 4 images, and so on.
